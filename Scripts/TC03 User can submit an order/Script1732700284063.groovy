...
response = WS.sendRequest(findTestObject('Submit an order', [('URL') : GlobalVariable.URL, ('accessToken') : GlobalVariable.accessToken]))

orderId = WS.getElementPropertyValue(response, 'orderId', FailureHandling.STOP_ON_FAILURE)
